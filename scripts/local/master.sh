...
sudo sed -i "s/\$KUBELET_EXTRA_ARGS/\$KUBELET_EXTRA_ARGS --node-ip=192.168.86.36/g" /etc/systemd/system/kubelet.service.d/10-kubeadm.conf
...
showmount -e 192.168.86.36
#sudo mkdir /data
#mount -t nfs -vvvv 192.168.86.36:/homedata /data
#echo '192.168.86.36:/homedata /data  nfs      defaults    0       0' >> /etc/fstab
