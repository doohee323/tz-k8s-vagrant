...
sudo sed -i "s/\$KUBELET_EXTRA_ARGS/\$KUBELET_EXTRA_ARGS --node-ip=192.168.0.82/g" /etc/systemd/system/kubelet.service.d/10-kubeadm.conf
...
#sudo mkdir /data
#mount -t nfs -vvvv 192.168.0.82:/homedata /data
#echo '192.168.0.82:/homedata /data  nfs      defaults    0       0' >> /etc/fstab
