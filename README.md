...
```
    -. checkout codes
       git clone https://github.com/doohee323/tz-k8s-vagrant.git
       cd tz-k8s-vagrant
    ...
    ex)
        ...
        github_id=doohee323       # your github_id
        github_token=               # your github token
        docker_url=index.docker.io
        dockerhub_id=doohee323    # your dockerhub_id
    ...
    tz-k8s-vagrant/resources/config.json
        
        {
            "auths": {
                "https://index.docker.io/v1/": {
                    "username":"doohee323",             # your dockerhub_id
                    "password":"xxxx",                  # your dockerhub_password
                    "email":"doohee323@gmail.com",      # your email
       ...
       echo -n 'doohee323:topzone!323' | base64
...
## -. Build Demo app
### cf) demo app: https://github.com/doohee323/tz-demo-app
```
