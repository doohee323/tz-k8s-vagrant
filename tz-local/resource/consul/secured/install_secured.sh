...
helm uninstall tutorial
helm install -f ./secure-dc1.yaml tutorial hashicorp/consul --version "0.23.1" --wait
#helm upgrade --install tutorial hashicorp/consul --set global.name=consul --set server.affinity=""
