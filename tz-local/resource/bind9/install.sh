...
options {
	...
	listen-on { 192.168.0.20; };   # ns1 private IP address - listen on private network only
...
dig @192.168.0.20 host2.t1zone.com
dig host2.t1zone.com
dig main.devops.eks-main-t.t1zone.com
dig consul.default.home-k8s.t1zone.com

dig @192.168.0.20 consul.default.home-k8s.t1zone.com
dig @192.168.0.20 test.default.home-k8s.t1zone.com
