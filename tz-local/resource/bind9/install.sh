...
options {
	...
	listen-on { 192.168.0.82; };   # ns1 private IP address - listen on private network only
...
* IN	A 192.168.86.36
;
ns1.t1zone.com.          IN      A       192.168.0.82
...
dig @192.168.0.82 host2.t1zone.com
dig host2.t1zone.com
dig main.devops.eks-main-t.t1zone.com
dig consul.default.home-k8s.t1zone.com

dig @192.168.0.82 consul.default.home-k8s.t1zone.com
dig @192.168.0.82 test.default.home-k8s.t1zone.com
