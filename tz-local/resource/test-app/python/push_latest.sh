...
#docker login 192.168.0.200:5000 -u="$USERNAME" -p="$PASSWD"
#docker tag tz-py-crawler 192.168.0.200:5000/doohee323/tz-py-crawler
#docker push 192.168.0.200:5000/doohee323/tz-py-crawler
