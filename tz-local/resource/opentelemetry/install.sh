...
# https://grafana.drillquiz.com/datasources/edit/tempo
...
curl -i http://opentelemetry.drillquiz.com/v1/traces -X POST -H "Content-Type: application/json" -d @span.json
...
processor = BatchSpanProcessor(OTLPSpanExporter(endpoint="http://opentelemetry.drillquiz.com/v1/traces"))
