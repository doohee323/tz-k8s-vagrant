...
#        ~~~~
#    }
#    harbor.harbor.topzone-k8s.drillquiz.com:53 {
#        hosts {
#            183.96.137.87    harbor.harbor.topzone-k8s.drillquiz.com
#        }
#    }
...
# nslookup harbor.harbor.topzone-k8s.drillquiz.com
...
#{
#    "insecure-registries": ["harbor.harbor.topzone-k8s.drillquiz.com"]
#}
#EOF
#service docker restart
#echo "Harbor12345" | docker login harbor.harbor.topzone-k8s.drillquiz.com -u admin --password-stdin
    ...
    [plugins."io.containerd.grpc.v1.cri".registry]
      [plugins."io.containerd.grpc.v1.cri".registry.mirrors]
        [plugins."io.containerd.grpc.v1.cri".registry.mirrors."docker.io"]
          endpoint = ["https://registry-1.docker.io", "https://harbor.harbor.topzone-k8s.drillquiz.com"]

    [plugins."io.containerd.grpc.v1.cri".registry.configs]
        [plugins."io.containerd.grpc.v1.cri".registry.configs."harbor.harbor.topzone-k8s.drillquiz.com".auth]
          username = "admin"
          password = "Harbor12345"
        [plugins."io.containerd.grpc.v1.cri".registry.configs."harbor.harbor.topzone-k8s.drillquiz.com".tls]
