...
{
        "insecure-registries" : [
          "nexus.topzone-k8s.drillquiz.com:5000"
        ]
}
...
echo '
##[ Nexus ]##########################################################
- url: http://nexus.topzone-k8s.drillquiz.com:8081
- id: admin
- passwd: cat /opt/sonatype-work/nexus3/admin.password

http://nexus.topzone-k8s.drillquiz.com:8081/#admin/repository/blobstores

Create blob store
  docker-hosted
  docker-hub

http://nexus.topzone-k8s.drillquiz.com:8081/#admin/repository/repositories
...
http://nexus.topzone-k8s.drillquiz.com:8081/#admin/security/realms
  add "Docker Bearer Token Realm" Active

docker login nexus.topzone-k8s.drillquiz.com:5000

docker pull busybox
RMI=`docker images -a | grep busybox | awk '{print $3}'`
docker tag $RMI nexus.topzone-k8s.drillquiz.com:5000/busybox:v20201225
docker push nexus.topzone-k8s.drillquiz.com:5000/busybox:v20201225

http://nexus.topzone-k8s.drillquiz.com:8081/#browse/browse:docker-hosted
