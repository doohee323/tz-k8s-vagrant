...
```
 ...
 - get jenkins url
   => http://jenkins.eks-main.topzone.iptime.org

 - setting kubernetes plugin
    http://jenkins.eks-main.topzone.iptime.org/configureClouds/
   - Name: k8s-aws  
 ...
 - add aws & github secrets  
    - github
      ...
      2. http://jenkins.eks-main.topzone.iptime.org/credentials/store/system/domain/_/newCredentials
        Kind: Username with password
        Username: ex) doohee323@topzone.iptime.org
        Password: ex) d465eaa43af65cececde0a63e310c2bxxxxxxxx
        ID: Github

    - aws
        http://jenkins.eks-main.topzone.iptime.org/credentials/store/system/domain/_/newCredentials
        Kind: Secret text
    ...
    - set a sample project (devops-crawler)
        http://jenkins.eks-main.topzone.iptime.org/ 
        - Github
            - Credentials: ex) doohee323@topzone.iptime.org
