...
```
 ...
 - get jenkins url
   in Workloads
   => http://192.168.86.36:31000/

 - install jenkins plugins
   http://192.168.86.36:31000/pluginManager/available
   install "Matrix Authorization Strategy"
   install "Kubernetes"
   https://plugins.jenkins.io/kubernetes/

 - setting kubernetes plugin
   http://192.168.86.36:31000/configureClouds/
   $> kubectl cluster-info
   Kubernetes URL: https://192.168.86.36:6443
