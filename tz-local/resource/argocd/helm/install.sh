...
#argocd login argocd.default.topzone-k8s.drillquiz.com:14444 --username admin --password ${TMP_PASSWORD} --insecure
...
curl https://argo-vault.devops.topzone-k8s.drillquiz.com/index
